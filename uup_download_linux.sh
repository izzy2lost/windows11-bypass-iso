...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=7605e73b-1674-42c6-86e4-8082d2f35242&pack=en-us&edition=core;professional&aria2=2"
if [ $? != 0 ]; then
